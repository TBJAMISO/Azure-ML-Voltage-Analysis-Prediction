...
# MeterForm = data['MeterForm']
# SubStationName = data['SubStationName']
# DimOrderPredictionKey  = data['DimOrderPredictionKey']
# DimReasonKey = data['DimReasonKey']
# NewestAvgVoltage = data['NewestAvgVoltage']
# Voltage = data['Voltage']
# SampleDateTime = data['SampleDateTime']
# TimeOfIntercept = data['TimeOfIntercept']